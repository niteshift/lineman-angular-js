...
11. Inclusion of lineman-bower to use bower for client side package management
12. Inclusion of Twitter Bootstrap for styling
13. Included common dependencies jquery, underscore, angular via bower
14. Integrated UI-Router
15. Added font-awesome for awesome!
16. Converted files to coffeescript
...
4. `npm install`
5. 'bower install'
6. gem install sass (you need ruby and rails installed for this)
5. `lineman run`
